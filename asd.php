...
<div align='center'>
<fieldset style="width:98%"><legend><h2>STUDENT DATA</h2></legend> <br>
<a href="apage.php">BACK<br /></a><br>
 <form action="asd.php" method="POST" > 
  ...
  <?php
      ...
      $result =  mysqli_query($conn,"SELECT name,emailid,rollno FROM student ");
	  ?>
      <table border="1">
       <tr height="90">
	 
      <th height="90" width="1%">ROLL NO</th>
      <th  width="15%">NAME</th>
